...
public class EnrichIntfTotalBytesWithDeviceDetails
    extends KeyedCoProcessFunction<
        String, EnrichedIntfTotalBytesMetric, Row, EnrichedIntfTotalBytesMetric> {

  private static final Logger LOG =
      LoggerFactory.getLogger(EnrichIntfTotalBytesWithDeviceDetails.class);
  private transient ValueState<Row> deviceCDCRow;

  @Override
  public void processElement1(
      EnrichedIntfTotalBytesMetric value,
